...
const Paint = loadable(() => import('@src/app/paint'), { fallback: <Loading /> });
const LeafFall = loadable(() => import('@src/app/leaf-fall'), { fallback: <Loading /> });
...
function App() {
  return (
    <Fragment>
      ...
      <Routes>
        <Route path="/" exact={true} element={<Paint />} />
        <Route path="/leaf-fall" element={<LeafFall />} />
